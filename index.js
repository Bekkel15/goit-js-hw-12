import{a as h,S as P,i as n}from"./assets/vendor-BjRz3xa9.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function r(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(e){if(e.ep)return;e.ep=!0;const o=r(e);fetch(e.href,o)}})();h.defaults.baseURL="https://pixabay.com/api/";const R="49705532-1e2ede49dc369f58ee6a018a1",x=(s,t)=>({params:{key:R,q:s,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:15,page:t}});async function L(s,t){return(await h.get("",x(s,t))).data}const B=new P(".item a",{captions:!0,captionsData:"alt",captionDelay:1e3});function u(s,t){const r=s.map(({largeImageURL:e,webformatURL:o,tags:i,likes:w,views:S,comments:$,downloads:O})=>`
    <li class= "item">
      <a href="${e}">
